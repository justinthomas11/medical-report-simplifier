...
from modules.input_handler import get_file_type
...
def main():
    ...
    filepath = r"C:\Users\Admin\Desktop\My stuff\Christ\3rd Sem\NLP\MedicalReportSimplifier\tests\sample_reports\sample_cbc.txt"
    ...
    # Force a standard model like gemini-1.5-flash which is fast and stable
    print("Querying Gemini...")
    raw_simplification = simplify_report(extracted_text, context, entities.to_dict())
    
    output_filepath = os.path.join(base_dir, "raw_simplification.txt")
    with open(output_filepath, "w", encoding="utf-8") as f:
        f.write(raw_simplification)
    print("Done! Saved output to raw_simplification.txt")
